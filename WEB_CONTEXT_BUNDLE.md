...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-56328"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-v1",
      "problem_contract_sha256": "7605c95573f19d1d6a847a966d1b0157fea137bc6725009330a67589e26b46f1",
      "problem_id": "problem:um-opg-56328-partitioning-the-projective-plane-fc63ccf6",
      "route_id": "route:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-source-fidelity-01",
      "graph_id": "graph:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Throughout this post, by projective plane we mean the set of all lines through the origin in $\\mathbb{R}^3$. Definition Say that a subset $S$ of the projective plane is octahedral if all lines in $S$ pass through the closure of two opposite faces of a regular octahedron centered at the origin. Definition Say that a subset $S$ of the projective plane is weakly octahedral if every set $S'\\subseteq S$ such that $|S'|=3$ is octahedral. Conjecture Suppose that the projective plane can be partitioned into four sets, say $S_1,S_2,S_3$ and $S_4$ such that each set $S_i$ is weakly octahedral. Then each $S_i$ is octahedral."
          },
          "statement_sha256": "0d029bc00c49e42e2af17f1dadf448f1a1c18d820bca73ad46ddc59bb4d631f9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-root",
      "route_id": "route:um-opg-56328-partitioning-the-projective-plane-fc63ccf6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Geometry problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-56328-b3081add1cbf",
        "url": "https://www.unsolvedmath.com/problems/OPG-56328"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
